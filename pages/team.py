...
team = [
    {
        ...
        "distribution": {
            "en": "Streamlit web development (menu & navigation), and report writing",
            "id": "Pengembangan web Streamlit (menu & navigasi) dan penulisan laporan"
        },
        "sid": "004202400102",
        "origin": "Gorontalo",
        "photo_file": "tris.jpg",
...
for member in team:
    ...
    with cols[1]:
        ...
        st.markdown(
    f"- **{t['distribution']}:** {member['distribution'][lang]}"
    )
    st.markdown("---")
